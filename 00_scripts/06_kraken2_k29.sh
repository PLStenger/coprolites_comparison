...
#SBATCH --job-name=07_kraken2_k29_cop
#SBATCH --ntasks=1
...
#SBATCH --error="/home/plstenge/coprolites_comparison/00_scripts/07_kraken2_k29.err"
#SBATCH --output="/home/plstenge/coprolites_comparison/00_scripts/07_kraken2_k29.out"

# ==============================================================================
# Script : 07_kraken2_k29.sh
# Author : Pierre-Louis Stenger
# Purpose :
# 1. Classification taxonomique avec Kraken2 (base de données k29)
...
echo "======================================================================="
echo " STEP 1: Kraken2 (k29) — reads merged (single-end)"
echo "======================================================================="
...
echo "======================================================================="
echo " STEP 2: Kraken2 (k29) — reads unmerged (paired-end)"
echo "======================================================================="
...
echo ""
echo "Analyse Kraken2 (k29) terminee pour tous les echantillons."
...
echo "======================================================================="
echo " STEP 3: Generation des graphiques Krona (k29)"
echo "======================================================================="
...
echo ""
echo "======================================================================="
echo " ALL STEPS COMPLETED — Kraken2 k29"
echo "======================================================================="
