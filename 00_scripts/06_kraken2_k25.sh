...
#SBATCH --job-name=07_kraken2_k25_cop
#SBATCH --ntasks=1
...
#SBATCH --error="/home/plstenge/coprolites_comparison/00_scripts/07_kraken2_k25.err"
#SBATCH --output="/home/plstenge/coprolites_comparison/00_scripts/07_kraken2_k25.out"

# ==============================================================================
# Script : 07_kraken2_k25.sh
# Author : Pierre-Louis Stenger
# Purpose :
# 1. Classification taxonomique avec Kraken2 (base de données k25)
...
echo "======================================================================="
echo " STEP 1: Kraken2 (k25) — reads merged (single-end)"
echo "======================================================================="
...
echo "======================================================================="
echo " STEP 2: Kraken2 (k25) — reads unmerged (paired-end)"
echo "======================================================================="
...
echo ""
echo "Analyse Kraken2 (k25) terminee pour tous les echantillons."
...
echo "======================================================================="
echo " STEP 3: Generation des graphiques Krona (k25)"
echo "======================================================================="
...
echo ""
echo "======================================================================="
echo " ALL STEPS COMPLETED — Kraken2 k25"
echo "======================================================================="
